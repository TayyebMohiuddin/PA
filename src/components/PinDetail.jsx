...
import { MdDownloadForOffline, MdDownloadfromOffline } from 'react-icons/md';
...
//                 .insert('after', 'comments[-1]', [{ comment, _key: uuidv4(), postedBy: { _type: 'postedBy', _ref: postedBy._id } }])
//                 .commit()
//                 .then(() => {
//                     fetchPinDetails();
//                     setComment('');
...
//                             </div>
//                             <a href={pinDetail.destination} target="_blank" rel="noreferrer">
//                                 link: {pinDetail.destination?.slice(8, 25)}
//                             </a>
//                         </div>
//                         <div>
//                             <h1 className="text-4xl font-bold break-words mt-3">
